...
const adicionarCreditoUsuarioController =
  new AdicionarCreditoUsuarioController();
...
usuarioRotas.post(
  "/adicionarCredito",
  ensureAuthenticated,
  adicionarCreditoUsuarioController.index
);
usuarioRotas.put(
  "/avatar",
  ensureAuthenticated,
  upload.single("avatar"),
  uploadAvatarController.index
);
usuarioRotas.get("/avatar/:userId/:fileName", (req, res) => {
